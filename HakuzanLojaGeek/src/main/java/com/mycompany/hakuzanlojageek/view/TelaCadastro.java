 ...
 */
package com.mycompany.hakuzanlojageek.view;
...
public class TelaCadastro extends javax.swing.JFrame {
    ...
    private void btnCadastraUserMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCadastraUserMousePressed
        Usuario user = new Usuario(txtNome.getText(),txtEmail.getText(),txtTelefone.getText(), txtLogin.getText(),txtPassword.getText(),txtEndereco.getText());
